...
const Dashboard = ({ user, onLogout }) => {
  ...
  const generarPDF = (cita) => {
    ...
    if (cita.proxima_cita_recomendada) {
      yPos = renderStructuredSection("Próxima Cita Recomendada (Tentativa)", cita.proxima_cita_recomendada, yPos);
    }
                ...
                {filteredHistorial.map(cita => (
                  <div className="historial-item" key={cita.id_cita}>
                    ...
                    <div className="historial-actions">
                      ...
                      {cita.proxima_cita_recomendada && (
                        <div className="proxima-cita-badge" style={{ marginTop: '8px', fontSize: '12px', color: '#008b85', fontWeight: '600', backgroundColor: '#e6f4f3', padding: '4px 8px', borderRadius: '4px', display: 'inline-block' }}>
                          📅 Próxima cita recomendada: {cita.proxima_cita_recomendada}
                        </div>
                      )}
